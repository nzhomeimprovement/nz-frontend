          ...
          <div className="md:col-span-12 lg:col-span-4">
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-400 hover:bg-[#D0956B] hover:border-[#D0956B] hover:text-zinc-950 hover:-translate-y-1 transition-all duration-300 text-xs font-bold"
              >
                IG
              </a>
              <a
